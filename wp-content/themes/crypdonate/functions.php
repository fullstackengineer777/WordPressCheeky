...
function twentysixteen_scripts() {
	...
	//cheeky
	// wp_enqueue_script('cheeky_jquery', 'https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js', array(), '3.6.0');
	// wp_enqueue_script('cheeky_jquerylazy', 'https://cdnjs.cloudflare.com/ajax/libs/jquery.lazy/1.7.9/jquery.lazy.min.js', array(), '1.7.9');
	// wp_enqueue_script('cheeky_jqueryplugin', 'https://cdnjs.cloudflare.com/ajax/libs/jquery.lazy/1.7.9/jquery.lazy.plugins.min.js', array(), '1.7.9');
	// // wp_enqueue_script('cheeky_checkout', get_template_directory_uri().'/greeting-assets/js/checkout.js', array(), '1.0');
	// wp_enqueue_script('cheeky_main', get_template_directory_uri().'/greeting-assets/js/main.js', array(), '1.0');
...
function twentysixteen_block_editor_styles() {
	...
	//cheeky
    // wp_enqueue_script('cheeky_style', get_template_directory_uri().'/greeting-assets/css/cheeky-style.css', array());
}
